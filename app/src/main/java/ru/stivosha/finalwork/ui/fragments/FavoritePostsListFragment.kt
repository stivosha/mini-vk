...
class FavoritePostsListFragment : MvpAppCompatFragment(), PostListView, PostItemClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_favorite_posts_list, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        hideProgress()
        initRecycler()
        presenter.loadPosts(isFavoritePosts = true)
    }
    ...
    private fun initRecycler() {
        ...
        postListRecyclerViewRefresh.setProgressBackgroundColorSchemeColor(ContextCompat.getColor(this.requireContext(), R.color.colorPrimary))
    ...
    private val onPostDismissListener: ((Post, Int) -> Unit) = { post, position ->
    ...
    companion object {
        fun createInstance(): Fragment = FavoritePostsListFragment()
    }
}